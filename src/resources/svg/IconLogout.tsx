    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g id='Iconly/Regular/Outline/Logout'>
        <g id='Logout'>
          ...
          <g id='Group 8'>
            <mask id='mask1_10850_6920' maskUnits='userSpaceOnUse' x='18' y='8' width='5' height='8'>
              <path
                id='Clip 7'
                fillRule='evenodd'
                clipRule='evenodd'
                d='M18.1096 8.33524H22.537V15.666H18.1096V8.33524Z'
                fill='white'
              />
            </mask>
            <g mask='url(#mask1_10850_6920)'>
              <path
                id='Fill 6'
                fillRule='evenodd'
                clipRule='evenodd'
                d='M18.8594 15.666C18.6674 15.666 18.4744 15.593 18.3284 15.445C18.0364 15.151 18.0374 14.677 18.3304 14.385L20.7244 12L18.3304 9.61599C18.0374 9.32399 18.0354 8.84999 18.3284 8.55599C18.6204 8.26199 19.0944 8.26199 19.3884 8.55399L22.3164 11.469C22.4584 11.609 22.5374 11.801 22.5374 12C22.5374 12.199 22.4584 12.391 22.3164 12.531L19.3884 15.447C19.2424 15.593 19.0504 15.666 18.8594 15.666Z'
                fill='#393939'
              />
            </g>
          </g>
